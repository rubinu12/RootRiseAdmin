...
import { recursiveVectorSearch } from "@/app/prelim/actions/recursive-search";
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="text-center">
          ...
          <p className="text-slate-500 mt-2">
            Hierarchical Vector Routing (L1 → L2 → L3)
          </p>
        </div>
        ...
        {result && result.success && (
          <div className="space-y-0 relative">
            ...
            {result.trace.map((step: any, i: number) => (
              <div
                key={i}
                className="relative flex items-start gap-4 animate-in slide-in-from-left-4 fade-in duration-500"
              ...
              <div className="flex-1 bg-emerald-50 p-6 rounded-2xl border border-emerald-100 shadow-md">
                ...
                {result.candidates && (
                  <div className="mt-4 pt-4 border-t border-emerald-100">
                    <p className="text-[10px] font-bold text-emerald-800 mb-2 uppercase">
                      Contenders:
                    </p>
